  ...
  return (
    <Link href={`${baseUrl}/${id}`} prefetch={false} className="group">
      <div
        ...
        className="relative overflow-hidden rounded-lg bg-zinc-900 cursor-pointer hover:shadow-lg transition-shadow h-full"
      >
        {/* Image */}
        <div suppressHydrationWarning className="relative h-60 w-full overflow-hidden bg-zinc-800">
          <img
            src={image}
            alt={title}
          ...
          <div
            suppressHydrationWarning
            className="absolute inset-0 bg-linear-to-t from-black via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-3"
          >
            {rating && (
        ...
        {/* Title */}
        <div suppressHydrationWarning className="p-3">
